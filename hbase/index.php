<?php
    /**
        ...
        put 'users',2,'info:name','Linux管理员'
        ...
        put 'users',3,'info:name','Windows管理员'
    ...
    print_r($client->search('users', [
        'filterString' => "SingleColumnValueFilter('info', 'telephone', =, 'binary:17612800917')"
    ]));