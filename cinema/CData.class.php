<?php
    ...
    class CData extends CBinary {
        ...
        private function __getArrayBinary($payload_id, $payload_data) {
            ...
            $refer=array(
                'sync_tag'=>$this->encrypt16UInt($this->__setting['sync'], $packet_length),   //同步标记
                'version'=>$this->encrypt8UInt($this->__setting['version'], $packet_length),   //版本
                'packet_length'=>$this->encrypt16UInt(0, $packet_length),   //报文总长度仅占位
                'payload_id'=>$this->encrypt8UInt($payload_id, $packet_length) //协议体标识
            );
